...
public class BinaryConverterTest {
    ...
    public void subtractTest() {
        BinaryConverter binaryConverter = new BinaryConverter();
        String binary1 = binaryConverter.subtract("101","010");
        String binary2 = binaryConverter.subtract("11001100","10101010");
        String binary3 = binaryConverter.subtract("101011","010110");
        String binary4 = binaryConverter.subtract("11011","11010");
        Assert.assertEquals(binary1, "11");
        Assert.assertEquals(binary2, "100010");
        Assert.assertEquals(binary3, "10101");
